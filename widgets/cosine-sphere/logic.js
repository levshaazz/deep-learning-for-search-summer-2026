...
export function mountCosineSphere(host, { data, labels = {}, pairId } = {}) {
  ...
  // caption panel (below the figure)
...
if (typeof window !== 'undefined') window.mountCosineSphere = mountCosineSphere;
