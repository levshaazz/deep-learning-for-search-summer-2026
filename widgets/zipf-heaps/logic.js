...
export function mountZipfHeaps(host, { data, labels = {} } = {}) {
  const W = 480, H = 440, MAX = 3;
  host.classList.add('wgt-root', 'zh-root', 'wgt-fade');
  host.innerHTML = '';
...
if (typeof window !== 'undefined') window.mountZipfHeaps = mountZipfHeaps;
