/* inverted-index/logic.js — the "explainable unit" for L3 inverted-index / postings.
   ...
   Built on the shared widgets/_widget-base.js factory: the factory owns the wgt-root/wgt-fade host
   setup, the caption/counter scaffold, the setStep clamp + host.dataset.step, the esc() helper and
   the window.mountInvertedIndex registration; render() below only draws the figure layers and
