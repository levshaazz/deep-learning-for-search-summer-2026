...
export function mountRankingMetrics(host, { data, labels = {} } = {}) {
  const MAX = 4, W = 480, H = 460;
  const ranked = data.ranked;

  host.classList.add('wgt-root', 'rm-root', 'wgt-fade');
  host.innerHTML = '';
...
if (typeof window !== 'undefined') window.mountRankingMetrics = mountRankingMetrics;
