    {
      ...
      body: {
        en: [
          ...
          "I trained a tiny character BPE on a 9:1 English-to-Russian mix and ran it on a parallel sentence. English *search* stayed **one** token; Russian *запроса* fell all the way to its **seven** characters. Across the sentence, English cost **1.0** tokens per word and Russian **5.8** — a ×2.9 tax on the same content. The exact ratio is our toy's; production multilingual tokenizers pay a smaller but real premium, often around two tokens per word.",
        ...
        ru: [
          "Первый счёт — **токен-налог**. BPE (из L2) учит слияния по частоте пар в корпусе обучения, который в подавляющей части английский, — и накапливает богатые английские подслова и почти никаких русских. Встретив русское слово, для которого слияний нет, он откатывается к символам, а двухбайтовая кодировка кириллицы в UTF-8 заставляет байтовый токенизатор начинать с ещё более мелких кусков.",
          "Я обучил крошечный символьный BPE на смеси английского к русскому 9:1 и прогнал на параллельной фразе. Английское *search* осталось **одним** токеном; русское *запроса* рассыпалось на **семь** символов. По фразе английский стоил **1,0** токена на слово, а русский — **5,8**, налог ×2,9 за тот же контент. Точное отношение — с нашей игрушки; продовые мультиязычные токенизаторы платят меньше, но реально — часто около двух токенов на слово.",
          "Налог тихий, но реальный. Больше токенов на слово — меньше смысла влезает в окно контекста, выше цена за токен и квадратичная задержка внимания, и всё это несёт русскоязычный пользователь за тот же запрос. Это сигнал цены, а не приговор точности, но именно он делает токенизатор критерием первого порядка при выборе модели для русского.",
        ],
        tt: [
          ...
          "Мин кечкенә хәреф BPE\'сын инглизчә-русча 9:1 катнашмасында өйрәттем һәм параллель җөмләдә эшләттем. Инглиз *search* **бер** токен булып калды; рус *запроса* **җиде** хәрефкә таркалды. Җөмлә буенча инглиз сүзгә **1.0** токен, ә рус — **5.8**, шул ук эчтәлеккә ×2.9 налог. Төгәл нисбәт — безнең toy\'ныкы; прод мультител токенизаторлары азрак, ләкин чын түли — еш кына сүзгә ике токен тирәсе.",
