    {
      ...
      body: {
        en: [
          ...
          "On our toy the payoff was one number: the gold answer's BM25 went from \\(0.0\\) to \\(1.3885\\), rank 2 to rank 1, the moment the forms matched. In production it is a multilingual encoder plus lemmatized BM25, fused, with the small orthographic cuts dressed — Tokenosaurus fed, the answer surfaced.",
        ...
        ru: [
          ...
          "На нашей игрушке развязка уместилась в одно число: BM25 золотого ответа поднялся с \\(0{,}0\\) до \\(1{,}3885\\), со второго места на первое, в тот момент, когда формы совпали. В проде это мультиязычный энкодер плюс лемматизированный BM25, слитые, с обработанными орфографическими порезами — Токенозавр накормлен, ответ всплыл.",
        ...
        tt: [
          ...
          "Безнең toy\'да түләү бер сан булды: алтын җавапның BM25\'е формалар туры килгән мизгелдә \\(0.0\\)\'дән \\(1.3885\\)\'кә, rank 2\'дән rank 1\'гә күтәрелде. Прод\'та бу — мультител энкодер плюс лемматизацияле BM25, кушылган, орфографик кисемнәре бәйләнгән — Токенозавр туйдырылган, җавап калыккан.",
