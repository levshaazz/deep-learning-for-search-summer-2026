    {
      ...
      body: {
        en: [
          "Take the chain L06 already worked end to end — «the cat sat» — and stop at the moment two wires meet. Row 0 of \\(Q\\) is \\((1, 0, 1, 0)\\); row 0 of \\(K\\) is \\((1, 0, 1, 0)\\). The cup does the only thing a cup ever does: multiply term by term along the shared axis, then add.",
        ...
        ru: [
          "Возьми цепочку, которую L06 уже прогнала от начала до конца — «the cat sat», — и остановись в тот миг, когда два провода сходятся. Строка 0 у \\(Q\\) — это \\((1, 0, 1, 0)\\); строка 0 у \\(K\\) — тоже \\((1, 0, 1, 0)\\). Чаша делает единственное, что чаша умеет: перемножает поэлементно вдоль общей оси и складывает.",
        ...
        tt: [
          "L06 инде башыннан ахырына кадәр эшләп чыккан чылбырны ал — «the cat sat» — һәм ике чыбык очрашкан мизгелдә туктал. \\(Q\\)’ның 0 нчы юлы — \\((1, 0, 1, 0)\\); \\(K\\)’ның 0 нчы юлы да \\((1, 0, 1, 0)\\). Касә үзе белгән бердәнбер эшне эшли: уртак күчәр буенча элементлап тапкырлый да куша.",
