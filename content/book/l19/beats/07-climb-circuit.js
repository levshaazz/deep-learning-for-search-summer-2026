    ...
    // NOT ncd-chain: L06 already mounts ncd-chain (l6-chain) as its climb, and re-running «the cat sat» here
    // would teach this chapter's reader nothing he did not get in L06 — same steps, same numbers, same figure.
    // ncd-attention does the work L06's climb cannot: it prices the axis while it is alive (12 heads: 6.3 MB
