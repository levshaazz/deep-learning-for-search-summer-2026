    {
      ...
      imgAlt: {
        ...
        ru: 'Четыре метрики RAGAS, разложенные сеткой два-на-два поверх ответа Оракула RAGdoll: верность и релевантность ответа оценивают генератор, точность и полнота контекста — ретривер; Серёга в зелёной тюбетейке указывает на одну низкую панель, чтобы локализовать отказавший этап.',
