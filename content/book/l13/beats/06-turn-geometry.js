    {
      ...
      body: {
        ...
        ru: [
          "Что делает негатив *сложным*? Геометрически — это тот, что близок к запросу по углу, с высоким \\(\\cos(q, d^-)\\). Лёгкий негатив далеко и уже отделён; сложный теснит запрос, и его легко спутать с правильным ответом.",
          "Возвращается Сэр Косинус, чтобы это измерить. Разложи запрос, его позитив и негативы на единичной дуге по углу — и сложность станет тем, что можно *увидеть*.",
        ],
        tt: [
