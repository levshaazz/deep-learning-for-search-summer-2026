    {
      ...
      body: {
        ...
        ru: [
          "Снижение \\(\\tau\\) обостряет софтмакс: вероятность сваливается на самого сложного кандидата, а потеря падает. Температура — **усилитель сложности**: она решает, насколько близкий промах (near-miss) доминирует в градиенте.",
