    {
      ...
      body: {
        ...
        ru: [
          "Снижение \\(\\tau\\) обостряет софтмакс: вероятность сваливается на самого трудного кандидата, а потеря падает. Температура — **усилитель трудности**: она решает, насколько близкий промах (near-miss) доминирует в градиенте.",
