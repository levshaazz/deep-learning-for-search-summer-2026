    {
      ...
      body: {
        ...
        ru: [
          ...
          "Достойный сложный негатив близок к запросу и далёк от позитива — толкай его смело. Самозванец близок к запросу *и* к позитиву: толкнёшь его — потянется и позитив. На взгляде только со стороны запроса оба выглядят одинаково: та же сложность, противоположная истина. Их не различить без второй оси или метки.",
        ],
        tt: [
