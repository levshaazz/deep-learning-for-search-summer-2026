    {
      ...
      body: {
        ...
        ru: [
          ...
          "Это **Импостор** — союзник в маске врага. Оттолкни его — и ты учишь модель отвергать верный ответ; а как покажут следующие биты, вместе с ним ты утягиваешь вниз и истинный позитив.",
        ],
        tt: [
          ...
          "Бу — **Самозванец**: дошман битлеген кигән иптәш. Аны этсәң — модельне дөрес җавапны кире кагарга өйрәтәсең; ә киләсе битләр күрсәткәнчә, аның белән бергә чын позитивны да түбән тартасың.",
        ],
      },
    },
