    {
      ...
      body: {
        ...
        ru: [
          ...
          "Огромный батч становится посильным благодаря приёму кэширования градиентов на реальном железе; отфильтрованные трудные негативы — то, что заостряет границу. Массивный батч — для разворота пространства, аккуратная горстка сложных, но честных негативов — для остроты: вся глава в одну строку.",
        ],
        tt: [
