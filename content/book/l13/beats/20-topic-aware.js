    {
      ...
      body: {
        ...
        ru: [
          "Есть способ дешевле, чем майнить гигантский индекс каждые несколько тысяч шагов: **производить** трудные негативы. Сначала кластеризуй запросы по теме, потом собирай каждый батч из *одной* темы. Теперь негативы из батча все по теме — сложные даром, без индекса для обновления.",
