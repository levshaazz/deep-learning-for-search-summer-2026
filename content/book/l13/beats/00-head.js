// content/book/l9.js — "Hyperspace Lanes" (L13): approximate nearest neighbour (HNSW, IVF, PQ),
// FAISS / vector DBs, and production serving (quantization, latency, caching). Beats match the L13 plan.
