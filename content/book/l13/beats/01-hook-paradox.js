    {
      ...
      body: {
        ...
        ru: [
          ...
          "Представь ретривер как клинок, а обучение — как кузницу. Клинок не заточить о воздух — остроту дают **противники**, с которыми он спаррингует. Выбери их плохо — остроты не будет; выбери ещё хуже — клинок затупится.",
        ],
        tt: [
          "Ике команда бер үк тыгыз ретривер кодын ала, бер үк мәгълүматта, бер үк архитектура белән өйрәтә. Берсе кирәкле пассажны диярлек һәрвакыт таба; икенчесе ачкыч сүзләр буенча эзләүне көчкә уза. Алар бары тик **негативлар** сайлавы белән аерылды — һәр сорау этәргә өйрәнә торган дөрес булмаган җаваплар.",
