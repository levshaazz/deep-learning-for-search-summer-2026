    {
      ...
      body: {
        en: [
          ...
          "Read the budget and the levers fall out. **ANN** turns the \\(520\\) ms scan into \\(12\\) ms — the whole reason this lecture exists. **Quantization** keeps the index in RAM so that \\(12\\) ms stays \\(12\\) ms. **Caching** makes repeated queries nearly free. And the re-rank — the most expensive hop at \\(60\\) ms — runs on only the *hundred* candidates ANN returned, not the billion. The cascade from Lecture 10 now sits *behind* the lanes.",
        ],
        ru: [
