    {
      ...
      body: {
        ...
        ru: [
          ...
          "Вот почему оценка без эталона — не компромисс, а шаг вперёд: она не просто говорит, *хороша* ли система, она говорит, *какой компонент* винить. Это разложение — вся причина, по которой RAGAS заслужил место первого свидетеля — но, как предупреждает следующий бит, у свидетеля есть и собственные пределы.",
        ],
        tt: [
