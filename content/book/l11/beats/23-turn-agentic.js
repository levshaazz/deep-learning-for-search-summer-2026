    {
      ...
      body: {
        ...
        ru: [
          ...
          "Это то же самокорректирующее семейство, что лекция 10 показала с CRAG и Self-RAG, теперь увиденное через призму оценки: каждый из этих методов в сердце — *генератор, что судит себя на лету*. Квадрат из четырёх метрик и LLM-судья дали нам словарь — релевантность, заземление, хорошо-ли-это-извлечение — а агентный цикл вплетает этот словарь в собственное принятие решений модели, ход за ходом.",
