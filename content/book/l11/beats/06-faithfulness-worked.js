    {
      ...
      body: {
        ...
        ru: [
          "Возьми настоящий ответ на *«Как сердце качает кровь?»* и разбей на атомарные утверждения. Верность спрашивает о каждом: **следует ли оно из извлечённого отрывка**? Сосчитай поддержанные, подели на общее число. Одно галлюцинированное предложение — сколь угодно беглое — роняет оценку на целую долю.",
          ...
          "Предложение про Гарвея — подсаженная галлюцинация: правдоподобный факт, что модель добавила из собственных параметров, не заземлённый ни в чём извлечённом. Верность ловит его напрямую — это метрика, что ставит число на *заземление*. Заметь: она ничего не говорит о том, по теме ли ответ и полон ли он; она лишь спрашивает, есть ли у каждого утверждения источник. В этом вся её работа, и она делает её арифметикой, что студент может проверить.",
        ],
        tt: [
          "*«Йөрәк канны ничек кудыра?»* дигәнгә чын җавапны ал һәм атомар раслауларга вата. Тугрылык һәрберсе турында сорый: **ул алынган өзектән киләме**? Раслангыннарны сана, гомуми санга бүл. Бер галлюцинацияләнгән җөмлә — никадәр шома булса да — бәяне бер өлешкә төшерә.",
