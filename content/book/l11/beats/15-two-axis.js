    {
      ...
      imgAlt: {
        ...
        ru: "Плоскость 2×2: горизонтальная ось трудности к запросу, где два негатива выглядят близнецами, и вертикальная ось сопутствующей опасности, где лишь один опасно сидит в окрестности позитива.",
      ...
      body: {
        ...
        ru: [
          "Самозванец обнажает путаницу, которую поле несло годами. *Трудность* — одна ось, \\(\\cos(q, d^-)\\): насколько близко кандидат к запросу. Но опасность живёт на **второй, ортогональной оси**, \\(\\cos(d^-, d^+)\\): насколько близко он к *позитиву*.",
          "Достойный трудный негатив близок к запросу и далёк от позитива — толкай его смело. Самозванец близок к запросу *и* к позитиву: толкнёшь его — потянется и позитив. На взгляде только со стороны запроса оба выглядят одинаково: та же трудность, противоположная истина. Их не различить без второй оси или метки.",
        ],
        tt: [
