    {
      ...
      imgCaption: {
        ...
        tt: 'Контакт. Машина ниһаять ике мәгънә якын булганны әйтә ала — Беренче контакт урнаштырылды.',
      },
      body: {
        en: [
          ...
          "But a question is already glowing on the console. Those vectors — where do their *directions* actually come from? So far the coordinates were just word counts, and counts don't know that *couch* and *sofa* mean the same thing; the Knights can compare directions beautifully, but only if something first points the words the right way. That's where we're headed later in the course. We're going to learn where meaning gets its coordinates — where *couch* and *sofa* finally land next to each other on the map: **embeddings.**",
        ],
        ru: [
          ...
          'Но на консоли уже мигает вопрос. Эти векторы — откуда вообще берутся их *направления*? Пока что координатами были просто счётчики слов, а счётчики не знают, что *couch* и *sofa* значат одно и то же; Рыцари прекрасно сравнивают направления, но лишь если что-то сперва развернёт слова в правильную сторону. Туда мы и держим путь — позже в курсе. Мы узнаем, где смысл получает свои координаты — где *couch* и *sofa* наконец оказываются рядом на карте: **эмбеддинги.**',
        ],
        tt: [
          'Миссияне санап чыгыйк. Без чит планеталының чи текстын санала торган берәмлекләргә әйләндердек — Токенозаврның өлеш-сүзләре, BPE кушылулары белән өйрәнелгән, Хипсның чиксез койрыгына карата чикләнгән. Аннары беренче Коралны төзедек: косинус, ул мәгънәне *юнәлеш* буенча үлчи һәм Евклидны алдаган катылыкка сизгерсез. Ә Үлчәмлек Каргышы Шәүләсе һәр ераклыкны бутка эретергә тырышканда, фокус торып калды — чөнки бары тик юнәлеш кенә исән кала торган берәмлек сферада Шәүлә концентрациясе хватканы югалта, ә Сэр Косинус һаман тора. Машина ниһаять ике мәгънә якын булганны хөкем итә ала. **Беренче контакт урнаштырылды.**',
          'Ләкин консольдә инде сорау җемелди. Бу векторлар — аларның *юнәлешләре* гомумән кайдан килә? Хәзергә координаталар бары тик сүз санаучылары иде, ә санаучылар *couch* белән *sofa* бер үк нәрсә аңлатканын белми; Рыцарьлар юнәлешләрне искиткеч чагыштыра, ләкин бары тик нәрсәдер башта сүзләрне дөрес якка борса гына. Без шунда таба барабыз — курсның алдагы өлешендә. Без мәгънә үз координаталарын кайдан алганын — *couch* белән *sofa* картада ниһаять янәшә кайда төшкәнен — белербез: **эмбеддинглар.**',
        ],
      },
    },
