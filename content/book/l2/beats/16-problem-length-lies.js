    {
      ...
      body: {
        ...
        tt: [
          'Токенлаштыру тәмам, һәр фраза хәзер саннар векторы — пространствода нокта, анда һәр координата фраза нинди дә бер билгене (тупаслап) күпме йөртә икәнен саный. Ике фразаны чагыштырыр өчен, ачык ход — аларның нокталары арасында туры сызык ераклыгын үлчәү: \\(\\lVert a - b\\rVert\\), мәктәптән өйрәнгән Евклид ераклыгы. Ачык… һәм ялгыш.',
