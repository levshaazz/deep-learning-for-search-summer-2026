    {
      ...
      body: {
        ...
        ru: [
          ...
          'Значит, нужна метрика — одно число на ранжирование. Но метрика бесполезна, если не с чем сравнивать: экзамен не оценить без ключа с ответами. Этот ключ называется **истиной** — эталонной разметкой (ground truth), и для поиска он означает — знать для какого-то набора запросов, какие документы действительно релевантны. Получи его — и смутное ощущение станет арифметикой. Весь остаток главы — два вопроса: откуда берётся ключ с ответами и как превратить его в честную оценку.',
        ],
        tt: [
