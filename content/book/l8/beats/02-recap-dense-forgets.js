    {
      ...
      body: {
        ...
        ru: [
          "Вспомни Разведчика из лекции 7: би-энкодер сворачивает весь документ в **один** вектор. Это быстро и кэшируется, но один вектор — это размытое среднее: редкое слово или точная фраза тонут в нём. Доказательство — бенчмарк BEIR: вне домена крепкий **BM25** достигает nDCG@10 \\(0{,}43\\), а плотный **DPR** отстаёт с \\(0{,}35\\). Один свёрнутый вектор — не вся история.",
        ...
        tt: [
          "7 нче лекциядәге Разведчикны исеңә төшер: би-энкодер бөтен документны **бер** векторга җыя. Бу тиз һәм кэшләнә, әмма бер вектор — томанлы уртача: сирәк сүз яки төгәл гыйбарә анда батып кала. Дәлил — BEIR бенчмаркы: домен тышында нык **BM25** nDCG@10 \\(0{,}43\\) ка җитә, ә тыгыз **DPR** — бары \\(0{,}35\\). Бер җыелган вектор — тулы хикәя түгел.",
