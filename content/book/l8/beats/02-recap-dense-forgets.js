    {
      ...
      body: {
        ...
        ru: [
          "Вспомни Разведчика из лекции 7: би-энкодер сворачивает весь документ в **один** вектор. Это быстро и кэшируется, но один вектор — это размытое среднее: редкое слово или точная фраза тонут в нём. Доказательство — бенчмарк BEIR: вне домена крепкий **BM25** достигает nDCG@10 \\(0{,}43\\), а плотный **DPR** отстаёт с \\(0{,}38\\). Один свёрнутый вектор — не вся история.",
