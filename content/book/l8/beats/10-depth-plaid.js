    {
      ...
      body: {
        en: [
          ...
          "The payoff is representative speedups of about \\(6.8\\times\\) on GPU and \\(45\\times\\) on CPU at no measurable quality loss on MS MARCO (the exact factor is dataset-dependent). Making a multi-vector index searchable at scale is the broader theme of approximate nearest-neighbour search — Lecture 9.",
        ],
        ru: [
          ...
          "Выигрыш — представительные ускорения около \\(6{,}8\\times\\) на GPU и \\(45\\times\\) на CPU без заметной потери качества на MS MARCO (точный множитель зависит от датасета). Сделать многовекторный индекс пригодным для поиска в большом масштабе — это более широкая тема приближённого поиска ближайших соседей, лекция 9.",
        ],
        tt: [
          ...
          "Отыш — MS MARCO да сизелерлек сыйфат югалтуысыз GPU да якынча \\(6{,}8\\times\\), CPU да \\(45\\times\\) вәкаләтле тизләнү (төгәл коэффициент датасетка бәйле). Күп-векторлы индексны зурлыкта эзләрлек итү — якынча иң якын күршеләрне эзләүнең киңрәк темасы, 9 нчы лекция.",
        ],
      },
    },
