    {
      ...
      body: {
        ...
        ru: [
          ...
          "Выигрыш — представительные ускорения около \\(6{,}8\\times\\) на GPU и \\(45\\times\\) на CPU без заметной потери качества на MS MARCO (точный множитель зависит от датасета). Сделать многовекторный индекс масштабно искабельным — это более широкая тема приближённого поиска ближайших соседей, лекция 9.",
        ],
        tt: [
