    {
      ...
      body: {
        ...
        ru: [
          ...
          "Выигрыш — типичные ускорения около \\(6{,}8\\times\\) на GPU и \\(45\\times\\) на CPU без заметной потери качества на MS MARCO (точный множитель зависит от датасета). Сделать многовекторный индекс пригодным для поиска в большом масштабе — это более широкая тема приближённого поиска ближайших соседей, лекция 9.",
        ],
        tt: [
