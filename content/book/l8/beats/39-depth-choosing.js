    {
      ...
      body: {
        ...
        tt: [
          "Бердәнбер дөрес архитектура юк — бары тоткарлык, хәтер, домен һәм мәгълүмат арасында компромисс бар. Тоткарлык һәм хәтер кысса, инвертланган индекстагы сирәк эзләүгә таян. Домен алмашынуы булса, гибрид (лексика плюс тыгызлык) һәрберсе ялгыз калдырган араны яба. Сыйфат мөһим булса һәм бюджет рөхсәт итсә, токен буенча төгәллек өчен ColBERT өст. Ә дәрәҗәле хөкемнәрең булса, барысының өстенә ранжлауга өйрәнү моделен куй.",
