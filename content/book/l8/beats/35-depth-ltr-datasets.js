    {
      ...
      body: {
        ...
        tt: [
          "Капитан өйрәтер өчен билгеләнгән мәгълүмат кирәк. **LETOR** иртә стандарт иде: релевантлык билгеле «запрос-документ» билге векторлары. **MSLR-WEB30K** — заманча бенчмарк: якынча \\(30\\text{K}\\) сорау, һәр «запрос-документ» пары \\(136\\) билге белән сурәтләнгән, \\(0\\) дән \\(4\\) кә кадәр дәрәҗәле релевантлык билгеләре белән.",
