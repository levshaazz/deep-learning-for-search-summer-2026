    {
      ...
      body: {
        en: [
          ...
          "It is not a museum piece. LambdaMART won the **Yahoo! Learning to Rank Challenge in 2010** and remains a strong, widely-deployed baseline — often the production ranker that the fancy neural scores merely *feed*. That is the payoff Lecture 7 pointed to: RankNet → LambdaRank → LambdaMART, the workhorse, arrived in full.",
        ],
        ru: [
          ...
          "Это не музейный экспонат. LambdaMART выиграл **Yahoo! Learning to Rank Challenge в 2010** и остаётся сильным, широко развёрнутым бейзлайном — часто это и есть продакшн-ранжировщик, который модные нейронные оценки лишь *кормят*. Это та кульминация, на которую указывала лекция 7: RankNet → LambdaRank → LambdaMART, рабочая лошадка, прибыла в полном составе.",
        ],
        tt: [
          ...
          "Бу музей әйбере түгел. LambdaMART **Yahoo! Learning to Rank Challenge ны 2010 елда** җиңде һәм нык, киң таралган бейзлайн булып кала — еш кына нәкъ шул продакшн-ранжлаучы, аны модалы нейрон балллар бары *туендыра*. Бу — 7 нче лекция күрсәткән кульминация: RankNet → LambdaRank → LambdaMART, эш аты, тулысынча килде.",
        ],
      },
    },
