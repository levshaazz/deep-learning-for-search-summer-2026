    {
      ...
      body: {
        ...
        tt: [
          ...
          "Бу музей әйбере түгел. LambdaMART **Yahoo! Learning to Rank Challenge ны 2010 елда** җиңде һәм нык, киң таралган бейзлайн булып кала — еш кына нәкъ шул продакшн-ранжлаучы, аны модалы нейрон баллар бары *туендыра*. Бу — 7 нче лекция күрсәткән кульминация: RankNet → LambdaRank → LambdaMART, эш аты, тулысынча килде.",
        ],
      },
    },
