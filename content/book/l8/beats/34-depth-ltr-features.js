    {
      ...
      body: {
        ...
        tt: [
          "Менә дүрт багана кушылган җир. Һәр \\((q, d)\\) пары билге векторына әйләнә, һәм беренче өч баганадан балллар анда — гади *билгеләр*: BM25, тыгыз косинус, SPLADE авырлыгы, ColBERT MaxSim — сорау озынлыгы, документ яше, басу саны һәм башкалар янәшәсендә.",
