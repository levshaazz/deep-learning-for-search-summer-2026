    {
      ...
      body: {
        en: [
          ...
          "On a real SPLADE model the effect is concrete: the query *river flood* keeps its literal terms (*river*, *flood*) but also lights up learned **expansion** terms — *rivers*, *flooding*, *floods*, *storm*, *reservoir* — neighbours a literal index would never match. That is term expansion, learned end-to-end and still sparse.",
        ],
        ru: [
          ...
          "На настоящей модели SPLADE эффект нагляден: запрос *river flood* сохраняет буквальные термины (*river*, *flood*), но дополнительно зажигает выученные термины **расширения** — *rivers*, *flooding*, *floods*, *storm*, *reservoir* — соседей, которых буквальный индекс никогда бы не нашёл. Это и есть расширение терминов, выученное от начала до конца и при этом разрежённое.",
        ],
        tt: [
          ...
          "Чын SPLADE моделендә эффект ачык: *river flood* сорауы үзенең хәрефи терминнарын (*river*, *flood*) саклый, ләкин шулай ук өйрәнелгән **киңәйтү** терминнарын кабыза — *rivers*, *flooding*, *floods*, *storm*, *reservoir* — хәрефи индекс беркайчан тапмаслык күршеләрне. Бу — баштан ахырга кадәр өйрәнелгән, шул ук вакытта сирәк термин киңәйтүе.",
        ],
      },
    },
