    {
      ...
      body: {
        ...
        ru: [
          ...
          "Замечательны две вещи. Модель назначила вес *bank* и *water*, не видя их в запросе, — это расширение терминов закрывает лексический разрыв. И оценка по-прежнему разрежённое скалярное произведение по общим терминам: та же арифметика инвертированного индекса, что у BM25, но с более богатым выученным сигналом.",
        ],
        tt: [
