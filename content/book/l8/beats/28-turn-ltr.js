    {
      ...
      body: {
        ...
        tt: [
          "Хәзер бездә сигналлар гаскәре: BM25, тыгыз косинус, SPLADE авырлыклары, ColBERT MaxSim, шулай ук яңалык, басулар, документ озынлыгы һәм башкалар. Гибрид берләштерү аларның икесен кушуның бер ысулы иде. Әмма синдә *дистә* сигнал булса һәм өйрәнү өчен билгеләнгән релевантлык хөкемнәре булса?",
          "Алайса син капитан өйрәтәсең. Ранжлауга өйрәнү (запрос, документ) парының билге векторын бер өйрәнелгән тәртипкә әйләндерә, ранжлау метрикасын турыдан-туры оптимальләштереп. Бу — 7 нче лекция вәгъдә иткән күпер — һәм монда кросс-энкодер реранкеры тулы өйрәнелгән ранжлау функциясенә гомумиләшә.",
        ],
      },
    },
