    {
      ...
      body: {
        ...
        ru: [
          "Зачем вообще сливать? Потому что две армии действительно дополняют друг друга. На zero-shot бенчмарке BEIR крепкий **BM25** держит nDCG@10 \\(0{,}43\\), а плотный **DPR** отстаёт с \\(0{,}38\\) — но на доменном MS MARCO порядок переворачивается, и плотный легко выигрывает. Лексический поиск ловит точные термины, редкие слова и идентификаторы; плотный — перефразировку и синонимию. Никто не доминирует везде.",
