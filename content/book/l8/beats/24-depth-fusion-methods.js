    {
      ...
      body: {
        ...
        ru: [
          ...
          "При небрежной — хрупко: один выброс ломает min-max, а правильный \\(\\alpha\\) меняется от запроса и домена. RRF обходит всё это, выбрасывая величины и оставляя лишь ранги — поэтому он надёжный дефолт, и поэтому продакшн-системы первым делом тянутся к нему.",
        ],
        tt: [
