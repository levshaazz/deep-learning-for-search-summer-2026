    {
      ...
      body: {
        ...
        tt: [
          "Соңгы тәэсир итешү бер үк вакытта ике күчәр буенча үзен аклый. **Сыйфат** буенча токен дәрәҗәсендәге векторлар сирәк сүзләрне һәм төгәл гыйбарәләрне күрә, аларны бер җыелган вектор томанлый, — кросс-энкодер укуына якын. **Хак** буенча документ токеннары офлайн кодлана һәм кэшләнә, шуңа сорауда син бары \\(|q| \\times |d|\\) арзан скаляр тапкырчыгыш өчен түлисең, ябыштырылган пар буенча трансформер узуы өчен түгел.",
