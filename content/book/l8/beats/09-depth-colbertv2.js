    {
      ...
      body: {
        ...
        ru: [
          "ColBERTv2 улучшает сразу два аспекта. **Обесшумленный надзор**: модель обучают дистилляцией из кросс-энкодера и добычей жёстких негативов — ровно рецепт из лекции 7 — что чистит обучающий сигнал и поднимает качество до MS MARCO MRR@10 \\(39{,}7\\). **Остаточное сжатие**: каждый токенный вектор становится индексом центроида плюс квантованный остаток, около \\(20\\)–\\(36\\) байт на вектор против \\(256\\) при наивном 16-битном хранении — сокращение в \\(6\\)–\\(10\\) раз.",
