    {
      ...
      body: {
        ...
        tt: [
          "Сорау белән документ өч ысул белән очраша ала. **Иртә пулинг** (би-энкодер, L7): чагыштырганчы *алдан* һәрберсен бер векторга җыю — арзан һәм кэшләнә, әмма детальләр югала. **Һәр катлау** (кросс-энкодер, L7): аларга һәр катлауда игътибар итешергә рөхсәт итү — төгәл, әмма балл — парның үзлеге, аны кэшләп булмый, һәм ул сорауга \\(O(N)\\).",
