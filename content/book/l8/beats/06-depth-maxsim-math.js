    {
      ...
      body: {
        en: [
          ...
          "A real ColBERTv2 model agrees on the very same query and documents: it scores \\(\\text{MaxSim} = \\mathbf{3.5462}\\) for the relevant document versus \\(\\mathbf{2.5407}\\) for the irrelevant one — far larger magnitudes than our toy cells (real per-token embeddings from the model, not hand-picked values in \\([0,1]\\)), yet the same verdict. Toy and real model agree on the ordering — and the ordering is the point.",
        ],
        ru: [
        ...
        tt: [
          ...
          "Чын ColBERTv2 моделе нәкъ шул ук сорау һәм документларда килешә: ул релевант документ өчен \\(\\text{MaxSim} = \\mathbf{3{,}5462}\\), релевант булмаганы өчен \\(\\mathbf{2{,}5407}\\) бирә — безнең уенчыктагыдан күпкә зуррак зурлыклар (модельнең чын токен вложениеләре, \\([0,1]\\) эчендә сайланган саннар түгел), әмма карар шул ук. Уенчык һәм чын модель тәртиптә туры килә — ә тәртип иң мөһиме.",
        ],
      },
    },
