    {
      ...
      body: {
        en: [
          ...
          "A real ColBERTv2 model agrees on the very same query and documents: it scores \\(\\text{MaxSim} = \\mathbf{3.5462}\\) for the relevant document versus \\(\\mathbf{2.5407}\\) for the irrelevant one — far larger magnitudes than our toy cells (real 768-dimensional token embeddings, not hand-picked values in \\([0,1]\\)), yet the same verdict. Toy and real model agree on the ordering — and the ordering is the point.",
        ],
        ru: [
