    {
      ...
      body: {
        ...
        ru: [
          'Современный энкодер строится в **три стадии**. Первая — **само-обучение** без меток: Inverse Cloze Task (предложение как псевдо-запрос к своему контексту), Contriever (случайные нарезки с моментум-очередью) или RetroMAE. Вторая — **слабо-надзорный контраст** на сотнях миллионов добытых пар при огромном батче — E5 использует ~270M пар.',
          'Третья — **дообучение** с добытыми трудными негативами и дистилляцией кросс-энкодера. Результат: E5 первым обошёл BM25 *zero-shot* на BEIR. А без доменных меток вовсе **GPL** генерирует синтетические запросы и псевдо-метит их кросс-энкодером, поднимая nDCG до девяти пунктов.',
        ],
        tt: [
          ...
          'Өченче — казылган авыр негативлар һәм кросс-энкодер дистилляциясе белән **дообучение**. Нәтиҗә: E5 BEIR\'да BM25\'не *zero-shot* узган беренче модель. Ә доменда бөтенләй билгеләр булмаганда **GPL** синтетик сораулар ясый һәм аларны кросс-энкодер белән псевдо-билгели, nDCG\'ны тугыз баллга кадәр күтәрә.',
        ],
      },
    },
