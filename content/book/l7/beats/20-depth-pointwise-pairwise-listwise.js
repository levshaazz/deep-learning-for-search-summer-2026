    {
      ...
      body: {
        ...
        tt: [
          ...
          '**Listwise** *бөтен исемлекне* метрикага оптимальләштерә: LambdaRank RankNet градиентларын алмаштырудан nDCG үзгәреше белән үлчи, ә **LambdaMART** аларны градиент бустинг агачларына сала — классик Learning-to-Rank\'ның күптәнге эш аты. RankNet → LambdaMART сызыгы — **8 нче лекциягә** күпер.',
        ],
      },
    },
