    {
      ...
      body: {
        ...
        ru: [
          ...
          'Но есть **ловушка**. Сырые трудные негативы — верхушка извлечённых документов — незаметно прячут в себе *ложные* негативы, на деле релевантные, и обучение на них **роняет** MRR примерно на шесть пунктов. Решение RocketQA — **очистить** их кросс-энкодером, обратив те же негативы в выигрыш. Трудный негатив, который на самом деле *двойник* ответа, отравляет обучение.',
        ],
        tt: [
