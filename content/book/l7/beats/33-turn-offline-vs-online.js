    {
      ...
      body: {
        ...
        ru: [
          ...
          '**Время запроса, онлайн:** эмбеддинг одного запроса, извлечение, переранжирование, сборка — **бюджет задержки живёт здесь**, и его меряют **A/B-тестами** по кликам и конверсии (callback L4). Спутаешь одно с другим — либо превысишь бюджет задержки, либо будешь пересобирать индекс на каждый запрос.',
        ],
        tt: [
