    {
      ...
      body: {
        ...
        ru: [
          'Часть мастерства Судьи можно передать обратно Разведчику. **Дистилляция кросс-энкодер &rarr; би-энкодер** учит быстрый би-энкодер подражать оценкам медленного кросс-энкодера — обычно потерей **margin-MSE** на *разностях* оценок. **TAS-B** (Hofstätter и др. 2021) — известный рецепт: тематически-осознанная выборка плюс дистилляция от двух учителей. Так реранкер поднимает извлекатель, а не только финальное ранжирование — мост к мультивекторным и гибридным извлекателям Лекции 8.',
        ],
        tt: [
