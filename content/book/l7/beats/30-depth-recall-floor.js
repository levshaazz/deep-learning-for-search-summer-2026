    {
      ...
      heading: { en: 'The recall ceiling', ru: 'Потолок отзыва', tt: 'Тулылык түшәме' },
      body: {
        en: [
        ...
        ru: [
          'У каскада жёсткий пол: Судья может ранжировать лишь те документы, что Разведчики реально принесли. Поэтому качество всего пайплайна ограничено **recall@k** извлекателя — если верного ответа нет в top-\\(k\\), который вернули Разведчики, никакой тщательный реранк его не вернёт. На наборе L4 отзыв растёт с глубиной: recall@1 = 0, recall@3 = 0.25, recall@5 = 0.5, recall@8 = 1.0. Извлечёшь слишком мелко — и ограничишь Судей ниже их потенциала. Сначала отзыв, потом точность — и никогда наоборот.',
        ],
        tt: [
