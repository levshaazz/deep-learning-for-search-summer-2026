    {
      ...
      heading: { en: 'You can&rsquo;t judge a galaxy', ru: 'Галактику не пересудить', tt: 'Галактиканы судить итеп булмый' },
      body: {
        en: [
        ...
        tt: [
          'Җентекле Судья сорауны **һәм** документны бергә укырга тиеш аларны бәяләр өчен — аның төгәллеге дә, бәясе дә шуннан. Бәя парга бәйле булганга, документ турында бернәрсә алдан исәпләп кэшләп булмый. Шуңа һәр сорау документка бер уку таләп итә: \\(O(N)\\) уку, биредә \\(N\\) — корпус зурлыгы. Йөз документта бу шунда ук; миллионда тәмамланмый; ә реаль корпуслар миллиард тота. Бер җентекле судья дәлилләр галактикасын сорау ала алмый.',
        ],
      },
    },
