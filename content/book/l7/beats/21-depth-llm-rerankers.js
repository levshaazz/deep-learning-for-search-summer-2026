    {
      ...
      body: {
        ...
        ru: [
          'Новейшие Судьи — это LLM, переранжирующие **listwise**: модели дают пронумерованное окно пассажей, и она выдаёт перестановку вроде \\([2]\\gt[3]\\gt[1]\\), двигая окно по кандидатам. Уроки резкие.',
