    {
      ...
      body: {
        ...
        ru: [
          'Насколько глубоко переранжировать? Глубина \\(k\\) — это ручка. Покрути вверх — Судьи видят больше выхода Разведчиков и могут вытащить ответы, зарытые глубже, — но каждый лишний кандидат это ещё один проход кросс-энкодера, и задержка растёт примерно линейно с \\(k\\). Покрути вниз — быстро, но рискуешь оставить хорошие ответы без суда. **Бесплатного \\(k\\) нет**: выбираешь самую мелкую глубину, что ещё ловит полноту твоего извлекателя, а остальное меняешь на бюджет задержки (твой SLA).',
        ],
        tt: [
