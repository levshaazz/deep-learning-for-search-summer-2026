    {
      ...
      body: {
        ...
        ru: [
          'Затем би-энкодер кодирует **весь корпус**, и векторы кладутся в индекс **приближённого поиска соседей** — лекарство от последней слабости Разведчика, линейного перебора, снижающее \\(N\\) скалярных произведений до \\(\\sim\\log N\\). **HNSW** строит граф «малого мира» с \\(M\\) (≈16–48 связей) и \\(efSearch\\), меняющим полноту на латентность; **IVF-PQ** делит пространство на ячейки и сжимает векторы до ~8 байт каждый для миллиардного масштаба.',
          'Полнота против латентности — ручка: на Sift1M полнота растёт от ~80% к ~100% с ростом efSearch. Полная история ANN — **Лекция 9**.',
        ],
        tt: [
