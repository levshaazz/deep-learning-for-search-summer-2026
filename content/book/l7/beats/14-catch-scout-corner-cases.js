    {
      ...
      body: {
        ...
        ru: [
          ...
          'Обобщение не бесплатно. Лекарства — сквозная линия остатка лекции: **мерь** на своём домене, **адаптируй** (дообучение или GPL) или **гибридизуй** с лексическим сигналом BM25.',
        ],
        tt: [
          ...
          'Гомумиләштерү бушлай түгел. Дәвалар — лекциянең калган өлешенең сызыгы: үз доменыгызда **үлчәгез**, **җайлаштырыгыз** (дообучение яки GPL), яки BM25\'нең лексик сигналы белән **гибридлаштырыгыз**.',
        ],
      },
    },
