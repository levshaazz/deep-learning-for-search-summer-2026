    {
      ...
      body: {
        ...
        tt: [
          'MTEB башындагы Разведчик барыбер начар күчә ала. MS MARCO\'да өйрәтелгән ретривер **домен тышында начарая** — BEIR\'да (zero-shot) BM25 nDCG@10 \\(\\mathbf{0.43}\\) бирә һәм еш кына бер тыгыз векторның \\(\\mathbf{0.38}\\)\'ен *уза*. Озын документлар токен чигенә төртелә һәм тавышсыз киселә; башка тел — бер телле модельгә; ә MIPS косинуска каршы векторларны бертөрле нормальләштерүне таләп итә.',
