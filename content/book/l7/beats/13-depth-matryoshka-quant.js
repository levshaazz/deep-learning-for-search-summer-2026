    {
      ...
      body: {
        ...
        ru: [
          ...
          '**Квантование** меняет тип чисел: **int8** вчетверо меньше при качестве выше 99%; **бинарные** — **в 32× меньше** и **~25× быстрее** (расстояние Хэмминга) при ~96%. Приём, возвращающий остаток: искать по квантованным, затем **пере-оценить топ-k в полной точности**. Вместе они ищут по всем 41M текстам Википедии примерно за секунду на CPU.',
        ],
        tt: [
