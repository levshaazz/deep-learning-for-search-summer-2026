    {
      ...
      body: {
        ...
        ru: [
          ...
          'Но **MTEB — это лидерборд, а не истина**: его средние считаются на разных версиях бенчмарка, многие числа — это числа, заявленные самими разработчиками моделей, и модель с вершины таблицы может проиграть на *вашем* корпусе. Используйте MTEB как короткий список, а финалистов меряйте на своих данных, языке и бюджете задержки.',
        ],
        tt: [
