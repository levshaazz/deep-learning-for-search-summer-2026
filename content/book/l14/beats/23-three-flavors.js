    {
      ...
      body: {
        ...
        ru: [
          ...
          "**Self-ask — это ВЫЗЫВАНИЕ.** Модель *задаёт себе* уточняющие вопросы вслух, отвечает на каждый и позволяет этим промежуточным ответам вытащить недостающее звено, прежде чем что-то утверждать (Press). Суть в том, что разбиение не обязано планироваться заранее — модель может *вызвать* следующий шаг из собственного частичного рассуждения.",
