    {
      ...
      body: {
        ...
        ru: [
          ...
          "Мультизапросное перефразирование плюс фьюжн через RRF — это ровно рецепт под названием **RAG-Fusion**. И весь ход держится на одном условии из прошлого такта: перефразировки должны по-настоящему *различаться*. Слей три формулировки, которые одинаково промахиваются мимо слова архива, — и согласие лишь заново подтвердит одну и ту же слепую зону.",
        ],
        tt: [
