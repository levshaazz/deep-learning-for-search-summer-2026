    {
      ...
      body: {
        ...
        ru: [
          ...
          "Оба отвечают на лексический разрыв одинаково — занимают слова у документов, которые запрос уже поднял. Рокчио двигает *точку*; RM двигает *распределение*. Держи их в голове порознь: это параллельные дороги к одной цели, а не родитель и дитя.",
        ],
        tt: [
