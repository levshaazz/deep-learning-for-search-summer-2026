    {
      ...
      body: {
        ...
        ru: [
          ...
          "В этом весь компромисс IVF: больше ячеек — выше recall, но дороже. Опасность — **пограничный сосед**, истинный сосед сразу за пределами собственной ячейки запроса. Одна ячейка всегда рискует его упустить; пара проб его возвращает. nprobe — ручка между скоростью и recall, и поэтому IVF сопровождают переранжированием возвращённых кандидатов.",
        ],
        tt: [
