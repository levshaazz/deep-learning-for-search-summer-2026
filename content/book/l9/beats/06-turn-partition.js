    {
      ...
      body: {
        ...
        ru: [
          "Граф идёт; **разбиение** сортирует. Инвертированный файл (IVF) сначала прогоняет \\(k\\)-средних по корпусу, выбирая сотни-тысячи **центроидов** и разбивая пространство на **ячейки** Вороного. Каждый вектор подшит под ближайший центроид — строится однажды, офлайн. На запросе вы не сканируете корпус; вы находите ячейки, ближайшие к запросу, и пробуете только их.",
        ],
        tt: [
