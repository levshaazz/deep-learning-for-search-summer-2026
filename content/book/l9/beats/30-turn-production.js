    {
      ...
      body: {
        ...
        ru: [
          ...
          "Так или иначе, запрос теперь — **запрос с бюджетом**. Он кодирует запрос, запускает ANN-поиск, переранжирует шорт-лист (кросс-энкодер из лекции 7, теперь *за* ANN), проверяет кэш и отвечает — всё под SLA по задержке. Этот бюджет — следующий подъём.",
        ],
        tt: [
