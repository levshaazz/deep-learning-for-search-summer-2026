    {
      ...
      heading: { en: 'Recall vs nprobe, by hand', ru: 'Recall против nprobe вручную', tt: 'Recall nprobe га каршы, кул белән' },
      body: {
        en: [
        ...
        ru: [
          ...
          "В этом весь компромисс IVF: больше ячеек — выше recall, но дороже. Опасность — **пограничный сосед**, истинный сосед сразу за пределами собственной ячейки запроса. Одна ячейка всегда рискует его упустить; пара проб его возвращает. nprobe — регулятор между скоростью и recall, и поэтому IVF сопровождают переранжированием возвращённых кандидатов.",
        ],
        tt: [
          "Борыч — **nprobe**: ничә иң якын күзәнәкне тикшерергә. Өч күзәнәктә тугыз нокта, \\(c_0\\) күзәнәгенә төшкән \\(q\\) сорауы һәм аның өч чын иң якын күршесен алыйк: икесе \\(c_0\\) эчендә, берсе нәкъ чик артында, \\(c_1\\) дә.",
