    {
      ...
      body: {
        ...
        tt: [
          'Индекс **вектор БД**\'да яши. FAISS — миллиард масштабта тулы контроль өчен китапханә; Qdrant, Weaviate, Milvus, Vespa һәм Elasticsearch — серверлар, күбесендә гибрид эзләү үзләренә кертелгән; pgvector векторларны Postgres эчендә тота. Масштаб, фильтрлар һәм гибрид «тартмадан» кирәкме икәнлеге буенча сайлагыз.',
