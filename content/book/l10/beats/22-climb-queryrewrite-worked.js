    {
      ...
      body: {
        ...
        ru: [
          ...
          "HyDE закрывает разрыв лексики, ища текстом в форме ответа; multi-query расширяет покрытие, спрашивая одно и то же по-разному. Оба поднимают recall, не трогая поисковик — просто подают ему запрос получше.",
        ],
        tt: [
