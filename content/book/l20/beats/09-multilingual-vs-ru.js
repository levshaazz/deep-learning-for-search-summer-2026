    {
      ...
      body: {
        ...
        ru: [
          "Мультиязычный путь — безопасный дефолт. **multilingual-E5** несёт те же префиксы *query:*/*passage:*, что английский E5, примерно на сотне языков. **BGE-M3** — флагман: 100+ языков, до 8192 токенов и — удобно для русского — три выхода за один проход: dense-вектор (L7), learned-sparse (как SPLADE, L8) и multi-vector (как ColBERT, L8), то есть гибрид из L8 внутри одной модели. **LaBSE** покрывает 109 языков, но это спец по битексту, лучше в поиске переводов, чем в ad-hoc.",
          "Ru-специфичный путь — ruBERT/ruRoBERTa как базы, sbert_large_nlu_ru и ru-en-RoSBERTa как sentence-энкодеры — оправдан на узком русском домене (юр., мед., госязык), где мультиязычная модель размазывает ёмкость по сотне языков. Иначе сильная мультиязычная часто не хуже.",
