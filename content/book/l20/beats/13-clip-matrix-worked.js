    {
      ...
      body: {
        ...
        ru: [
          ...
          ":::calc Косинусная матрица \\(\\cos(\\text{img}_i, \\text{txt}_j)\\) выходит такой: \\(\\begin{bmatrix} \\mathbf{0{,}9974} & 0{,}6547 & 0{,}171 \\\\ 0{,}6609 & \\mathbf{0{,}991} & 0{,}2877 \\\\ 0{,}1712 & 0{,}329 & \\mathbf{0{,}9949} \\end{bmatrix}\\). Возьми \\(\\operatorname*{arg\\,max}_j\\) каждой строки: лучшее совпадение каждый раз — **диагональ**: кросс-модальный поиск верен \\(\\mathbf{3/3}\\). Усредни совпавшие (диагональные) ячейки: \\(\\overline{\\cos}_{\\text{matched}} = \\tfrac{0{,}9974 + 0{,}991 + 0{,}9949}{3} = \\mathbf{0{,}9944}\\). Усредни шесть внедиагональных: \\(\\overline{\\cos}_{\\text{mismatched}} = \\tfrac{2{,}2745}{6} = \\mathbf{0{,}3791}\\). **Контрастный разрыв** — \\(0{,}9944 - 0{,}3791 = \\mathbf{0{,}6153}\\). :::",
          "Совпавшие пары сидят около \\(1{,}0\\); всё прочее — около \\(0{,}38\\). Этот разрыв \\(\\mathbf{0{,}6153}\\) — ровно почему диагональ выигрывает так чисто, и это не случайность. Это **контрастная цель**, сделанная видимой.",
        ],
        tt: [
