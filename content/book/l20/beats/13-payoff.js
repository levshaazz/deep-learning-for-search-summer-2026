    {
      ...
      body: {
        en: [
          ...
          "Not a new model. The familiar pipeline, honestly tuned for Russian — and the same discipline waiting for any language that does not happen to be English.",
        ],
        ru: [
          ...
          "На нашем toy расплата была одним числом: BM25 золотого ответа поднялся с \\(0{,}0\\) до \\(1{,}3884\\), с rank 2 на rank 1, в тот момент, когда формы совпали. В проде это мультиязычный энкодер плюс лемматизированный BM25, слитые, с обработанными орфографическими порезами — Токенозавр накормлен, ответ всплыл.",
          "Не новая модель. Знакомый конвейер, честно настроенный под русский, — и та же дисциплина ждёт любой язык, который не оказался английским.",
        ],
        tt: [
          ...
          "Яңа model түгел. Таныш конвейер, русча намус белән көйләнгән — һәм шул ук дисциплина инглиз булып чыкмаган теләсә кайсы телне көтә.",
        ],
      },
    },
