    {
      ...
      body: {
        en: [
          ...
          "The fix is a single, audacious idea: train an **image encoder** and a **text encoder** to map into the *same* coordinate system, so a photograph and the sentence that describes it land **next to each other**. This is **CLIP** (Radford et al., OpenAI, 2021). Once image and text share one space, cross-modal retrieval is just nearest-neighbour search — the very lanes we built in L13, now reaching across modalities. And the knight who measures the distance is one we already know: **Sir Cosine**.",
        ],
        ru: [
          ...
          "Решение — одна дерзкая идея: обучить **кодировщик изображений** и **кодировщик текста** отображать в *одну* систему координат, чтобы фотография и описывающее её предложение оказались **рядом**. Это **CLIP** (Radford и др., OpenAI, 2021). Когда изображение и текст делят одно пространство, кросс-модальный поиск — это просто поиск ближайшего соседа: те самые коридоры из L13, теперь дотягивающиеся между модальностями. А рыцарь, который меряет расстояние, нам уже знаком — **Сэр Косинус**.",
        ],
        tt: [
          "GraphRAG Корабльгә язмалар **аша** фикер йөртергә мөмкинлек бирде. Икенче фронтир аңа бөтенләй текст булмаган язмаларны эзләргә мөмкинлек бирә. Дөнья мәгълүматының яртысы — **рәсем**: диаграмма, счёт сканы, график, фоторәсем. Текст эзләве боларның барысына да сукыр.",
          "Чишелеш — бер кыю фикер: **рәсем кодлаучысын** һәм **текст кодлаучысын** *бер үк* координаталар системасына чагылдырырга өйрәтү, фоторәсем һәм аны тасвирлаган җөмлә **янәшә** төшсен өчен. Бу — **CLIP** (Radford һ.б., OpenAI, 2021). Рәсем һәм текст бер киңлекне бүлешкәч, кросс-модаль эзләү — гади иң якын күрше эзләве: L13 дагы шул ук коридорлар, хәзер модальлекләр арасына сузыла. Ә араны үлчәгән рыцарь безгә инде таныш — **Сэр Косинус**."
        ],
      },
    },
