    {
      ...
      body: {
        ...
        ru: [
          "Свести формы можно двумя способами. **Стемминг** правилами отрезает окончание, давая основу, которая не обязана быть словом (Snowball/Porter для русского): дёшево, без учёта контекста и с риском over/under-stemming, склеивающего чужие слова. **Лемматизация** приводит к словарной форме по морфологическому словарю и умеет снимать омонимию — *стали* это и *сталь*, и *стать*.",
          ...
          "Единственное непреложное правило, что бы вы ни выбрали: применяй **одну и ту же** нормализацию к запросу и к корпусу. Нормализуешь индекс, но не запрос — или наоборот — и возвращаешь ровно тот рассинхрон, который пытался убрать.",
        ],
        tt: [
