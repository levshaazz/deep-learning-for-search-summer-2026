    {
      ...
      body: {
        ...
        ru: [
          ...
          "Это урок Гудхарта из L4 в новом наряде: высокий балл на неверном распределении — не то, что ты хочешь измерить. Выбирай по MIRACL и ruMTEB; mMARCO — для масштаба и обучения, помня о смещении.",
        ],
        tt: [
