    {
      ...
      body: {
        ...
        tt: [
          'Менә без төзегән Корабль, һәм ул *тиз* эзли. Инвертацияләнгән индекс — аралыклар белән кысылган, skip-кушу белән, сегмент кушу белән — обреченный скан урынына шунда ук эзләү өчен. Документларны векторларга әйләндерү өчен сүзләр капчыгы. Сүзләрне үлчәр өчен TF-IDF, аннары аларны *дөрес* үлчәр өчен утыз ел BM25. Сорау кирәкмәгән абруй өчен PageRank. Һәм рангларны реципрок берләштерү, навигаторлар киңәшмәсе, бу килешмәгән тавышларны бер намуслы тәртипкә җыяр өчен. Бу — бу курстагы һәр купшы нейрон методы алырга тиешле базис планка — һәм син аның ничек еш кына гади генә җиңүенә чыннан да гаҗәпләнерсең.',
