    {
      ...
      body: {
        ...
        ru: [
          ...
          'А бюджет, с которым ты воюешь, беспощаден. Всё, что меньше примерно **100 миллисекунд**, пользователь воспринимает как мгновенное, секунду ещё терпит до ощущения тормоза, а через две-три уходит. И эти 100 мс даже не все твои — обмен по сети, отрисовка страницы и другие сервисы в запросе откусывают по куску, так что времени, чтобы ранкер *подумал*, остаётся лишь доля от них. Скан, которому нужны минуты, чтобы тронуть миллиард документов, перерасходовал бюджет на семь порядков ещё до того, как отранжировал хоть один результат.',
