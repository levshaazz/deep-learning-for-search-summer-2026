    {
      ...
      body: {
        ...
        tt: [
          ...
          "**Контекстсыз**, буш эзләү белән, модель **тыелмый**. Ул конкрет үзенчәлекләрне конфабуляцияли — *«9000 вектордан торган җыелма… зур масштаблы датасет…»* — шома, ышанычлы һәм тулысынча уйлап чыгарылган. Кулланучы өчен бу чын җаваптан **аерылмый**; нәкъ менә шул аны куркыныч итә.",
          "Хәзер шул ук сорауны мондый база юк дип әйткән алынган контекстта **нигезлә**. Модель **тыела**: *«Мин бу сорауга җавап бирә алмыйм. Контекст бернинди мәгълүмат бирми…»* Шул ук модель, шул ук сорау — нигезләү плюс баш тарту иреге ышанычлы уйдырманы намуслы баш тартуга әйләндерә. **Галлюцинация — зыян; нигезләү плюс тыелу — контроль.**"
        ],
      },
    },
