    {
      ...
      body: {
        ...
        ru: [
          ...
          "Знакомься — **Джоуи Многопрыг**, который никогда не ищет одну запись: он *прыгает* по рёбрам. От узла компании он идёт по ребру *founded_by* к основателю, затем по ребру *studied* к области. Ответ, который не жил ни в одном документе, живёт в **пути**. Это **GraphRAG** (Edge и др., Microsoft, 2024): поиск — больше не найти-один-отрывок; это **пройти-граф**.",
        ],
        tt: [
