    {
      ...
      body: {
        ...
        ru: [
          ...
          "Так встрой это: запусти **проверку верности** — LLM-судью или NLI-модель — *до* показа ответа, и если он ниже порога — **воздержись**. Это вся нить последних двух лекций, затянутая: L11 научил нас *судить* Оракула; L12 говорит, что мы **обязаны**. Измерять верность было методом; принуждать к ней — этика.",
        ],
        tt: [
