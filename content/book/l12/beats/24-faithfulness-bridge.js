    {
      ...
      body: {
        ...
        tt: [
          ...
          "Шуңа моны җайла: җавап күрсәтелгәнче, **тугрылык тикшерүен** — LLM-хөкемче яисә NLI модель — эшләт, һәм ул бусагадан түбән булса — **тыел**. Бу — соңгы ике лекциянең бөтен җебе, кысылган: L11 безне Оракулны *хөкем итәргә* өйрәтте; L12 без моңа **бурычлы** ди. Тугрылыкны үлчәү — ысул иде; аны мәҗбүр итү — этика."
        ],
      },
    },
