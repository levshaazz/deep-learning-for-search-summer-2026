    {
      ...
      body: {
        en: [
          ...
          "So wire it in: run a **faithfulness check** — an LLM-judge or an NLI model — *before* the answer is shown, and if it falls below threshold, **abstain**. That is the whole thread of the last two lectures, tightened: L11 taught us to *judge* the Oracle; L12 says we are **obliged** to. Measuring faithfulness was a method; enforcing it is an ethic.",
        ],
        ru: [
          ...
          "Так встрой это: запусти **проверку верности** — LLM-судью или NLI-модель — *до* показа ответа, и если он ниже порога — **воздержись**. Это вся нить последних двух лекций, затянутая: L11 научил нас *судить* Оракула; L12 говорит, что мы **обязаны**. Измерять верность было методом; добиваться её соблюдения — этика.",
        ],
        tt: [
          ...
          "Шуңа моны җайла: җавап күрсәтелгәнче, **тугрылык тикшерүен** — LLM-хөкемче яисә NLI модель — эшләт, һәм ул бусагадан түбән булса — **баш тарт**. Бу — соңгы ике лекциянең бөтен җебе, кысылган: L11 безне Оракулны *хөкем итәргә* өйрәтте; L12 без моңа **бурычлы** ди. Тугрылыкны үлчәү — ысул иде; аны мәҗбүр итү — этика."
        ],
      },
    },
