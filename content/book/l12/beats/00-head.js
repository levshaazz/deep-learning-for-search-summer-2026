// content/book/l8.js — "The Alliance" (L12): late interaction (ColBERT), learned sparse (SPLADE),
// hybrid fusion, and Learning to Rank (RankNet → LambdaRank → LambdaMART). Beats match the L12 plan
