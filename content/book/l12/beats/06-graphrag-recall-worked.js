    {
      ...
      body: {
        ...
        ru: [
          "Оценим обе стратегии на якорном вопросе простейшей метрикой: **появляется ли ответный узел в том, что мы извлекли?** Бинарный индикатор попадания ответа, \\(\\text{recall} = \\mathbb{1}[\\text{answer node} \\in \\text{retrieved}]\\), где ответный узел — **computer science**. (Это случай одного узла, а не Recall@k из L4 — *доли* извлечённых релевантных элементов; слово мы здесь переиспользуем.)",
        ...
        tt: [
          "Ике стратегияне дә таяныч сорауда иң гади метрика белән бәялик: **җавап төене без алган нәрсәдә бармы?** Җавап табылу-табылмавының бинар индикаторы, \\(\\text{recall} = \\mathbb{1}[\\text{answer node} \\in \\text{retrieved}]\\), монда җавап төене — **computer science**. (Бу — бер төен очрагы, L4 тәге Recall@k түгел — алынган релевант элементларның *өлеше*; сүзне без монда яңадан кулланабыз.)",
