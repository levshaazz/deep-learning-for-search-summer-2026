    {
      ...
      body: {
        en: [
          "Let's grade both strategies on the anchor question with the simplest possible metric: **does the answer node appear in what we retrieved?** A binary recall, \\(\\text{recall} = \\mathbb{1}[\\text{answer node} \\in \\text{retrieved}]\\), with the answer node being **computer science**.",
        ...
        ru: [
          "Оценим обе стратегии на якорном вопросе простейшей метрикой: **появляется ли ответный узел в том, что мы извлекли?** Бинарная полнота, \\(\\text{recall} = \\mathbb{1}[\\text{answer node} \\in \\text{retrieved}]\\), где ответный узел — **computer science**.",
        ...
        tt: [
          "Ике стратегияне дә таяныч сорауда иң гади метрика белән бәялик: **җавап төене без алган нәрсәдә бармы?** Бинар тулылык, \\(\\text{recall} = \\mathbb{1}[\\text{answer node} \\in \\text{retrieved}]\\), монда җавап төене — **computer science**.",
