    {
      ...
      body: {
        ...
        ru: [
          ...
          "А LambdaMART учится их взвешивать. Это не конкурент ретриверам; это капитан, который решает для каждого запроса, насколько доверять каждому. Нейронные ретриверы находят кандидатов; выученный ранкер решает финальный порядок.",
        ],
        tt: [
          "Менә дүрт багана кушылган җир. Һәр \\((q, d)\\) пары билге векторына әйләнә, һәм беренче өч баганадан баллар анда — гади *билгеләр*: BM25, тыгыз косинус, SPLADE авырлыгы, ColBERT MaxSim — сорау озынлыгы, документ яше, кликлар саны һәм башкалар янәшәсендә.",
