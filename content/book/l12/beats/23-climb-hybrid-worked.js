    {
      ...
      body: {
        ...
        ru: [
          "RRF даёт каждому документу голос \\(1/(k+\\text{ранг})\\) от каждого списка и суммирует их; стандартная константа — \\(k=60\\). Возьмём пять документов, где разрежённый и плотный ранкери расходятся.",
          ...
          "В этом весь смысл слияния по рангам. D1 был чьим-то №1, но один сильный голос не перевесил два крепких голоса D2. Согласие обоих ранкеров побеждает однобокого фаворита — и для этого не понадобилась калибровка оценок, только ранги.",
        ],
        tt: [
