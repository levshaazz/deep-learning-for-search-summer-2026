    {
      ...
      body: {
        ...
        ru: [
          ...
          ":::calc Для каждого изображения llava показывают пять подписей-кандидатов и спрашивают, какая подходит — *«Ответь только номером»*. Это **генеративная** модель, а не дуальный энкодер CLIP, поэтому здесь нет ни эмбеддинга картинки, ни косинуса: она читает картинку и подписи и *генерирует* свой выбор \\(j^\\star\\). На всех пяти бестекстовых фигурах её выбор был верной подписью. Точность top-1 \\(= 5/5 = \\mathbf{1.0}\\). :::",
        ...
        tt: [
          ...
          ":::calc Һәр рәсем өчен llava га биш кандидат язма күрсәтелә һәм кайсысы туры килгәне сорала — *«Бары номер белән җавап бир»*. Бу — **генератив** модель, CLIP дуаль энкодеры түгел, шуңа монда рәсем эмбеддингы да, косинус та юк: ул рәсемне һәм язмаларны укый һәм үз сайлавын *генерацияли* \\(j^\\star\\). Биш текстсыз фигураның барысында да аның сайлавы дөрес язма булды. Top-1 төгәллеге \\(= 5/5 = \\mathbf{1.0}\\). :::",
