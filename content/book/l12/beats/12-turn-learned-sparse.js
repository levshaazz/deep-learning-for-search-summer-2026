    {
      ...
      body: {
        ...
        ru: [
          "BM25 (лекция 3) взвешивает только буквально присутствующие слова, сырой частотой термина на обратную документную частоту. Это быстро и живёт в инвертированном индексе — но есть словарный разрыв: запрос «river flood» никогда не зажжёт «water» или «riverbank».",
