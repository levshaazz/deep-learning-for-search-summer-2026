    {
      ...
      body: {
        en: [
          ...
          "Then you train a captain. Learning to Rank turns a feature vector per (query, document) pair into one learned order, optimizing a ranking metric directly. This is the bridge Lecture 10 promised — and it is where the cross-encoder reranker generalizes into a whole learned ranking function.",
        ],
        ru: [
          ...
          "Тогда ты обучаешь капитана. Обучение ранжированию превращает вектор признаков пары (запрос, документ) в один выученный порядок, оптимизируя метрику ранжирования напрямую. Это тот мост, который обещала лекция 10 — и здесь реранкер-кросс-энкодер обобщается в целую выученную функцию ранжирования.",
        ],
        tt: [
          ...
          "Алайса син капитан өйрәтәсең. Ранжлауга өйрәнү (сорау, документ) парының билге векторын бер өйрәнелгән тәртипкә әйләндерә, ранжлау метрикасын турыдан-туры оптимальләштереп. Бу — 10 нче лекция вәгъдә иткән күпер — һәм монда кросс-энкодер реранкеры тулы өйрәнелгән ранжлау функциясенә гомумиләшә.",
        ],
      },
    },
