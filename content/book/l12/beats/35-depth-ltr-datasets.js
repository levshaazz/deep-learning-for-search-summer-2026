    {
      ...
      body: {
        en: [
          ...
          "Those graded labels are exactly what nDCG (Lecture 5) was built to measure — which is why LambdaMART, optimizing \\(\\Delta\\)nDCG, is such a natural fit for these datasets.",
        ],
        ru: [
          ...
          "Эти градуированные метки — ровно то, что nDCG (лекция 5) создан измерять — поэтому LambdaMART, оптимизирующий \\(\\Delta\\)nDCG, так естественно подходит этим датасетам.",
        ],
        tt: [
          ...
          "Бу дәрәҗәле билгеләр — нәкъ nDCG (5 нче лекция) үлчәргә ясалган нәрсә — шуңа \\(\\Delta\\)nDCG ны оптимальләштерүче LambdaMART бу датасетларга шулкадәр табигый туры килә.",
        ],
      },
    },
