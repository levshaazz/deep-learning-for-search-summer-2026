    {
      ...
      body: {
        ...
        ru: [
          ...
          "Это не музейный экспонат. Ансамбль на основе LambdaMART выиграл **Yahoo! Learning to Rank Challenge в 2010** (LambdaMART был ядром победившей комбинации) и остаётся сильным, широко развёрнутым бейзлайном — часто это и есть продакшн-ранкер, который модные нейронные оценки лишь *кормят*. Это та кульминация, на которую указывала лекция 10: RankNet → LambdaRank → LambdaMART, рабочая лошадка, прибыла в полном составе.",
        ],
        tt: [
          ...
          "Бу музей әйбере түгел. LambdaMART нигезендәге ансамбль **Yahoo! Learning to Rank Challenge ны 2010 елда** җиңде (LambdaMART җиңүче блендингның үзәге иде) һәм нык, киң таралган бейзлайн булып кала — еш кына нәкъ шул продакшн-ранжлаучы, аны модалы нейрон баллар бары *туендыра*. Бу — 10 нче лекция күрсәткән кульминация: RankNet → LambdaRank → LambdaMART, эш аты, тулысынча килде.",
        ],
      },
    },
