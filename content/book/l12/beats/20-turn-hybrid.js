    {
      ...
      body: {
        ...
        ru: [
          ...
          "Решение — забыть про оценки и сливать по **рангам**. Это слияние обратных рангов (RRF), с которым ты уже встречался в лекции 3 — только там оно сливало два классических ранкера, а здесь объединяет нейронных партнёров.",
        ],
        tt: [
