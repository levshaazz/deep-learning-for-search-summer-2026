    {
      ...
      body: {
        en: [
          "LambdaRank's insight is to skip the loss and define the *gradient* directly — and to weight it by how much the ranking metric would improve if you swapped the pair. The gradient magnitude is \\(1 - \\sigma(s_i - s_j)\\), and the weight is \\(|\\Delta\\text{nDCG}|\\) (the nDCG from Lecture 5).",
        ...
        ru: [
          "Прозрение LambdaRank — пропустить функцию потерь и задать *градиент* напрямую, взвесив его на то, насколько улучшится метрика ранжирования, если поменять пару местами. Величина градиента — \\(1 - \\sigma(s_i - s_j)\\), а вес — \\(|\\Delta\\text{nDCG}|\\) (nDCG из лекции 5).",
        ...
        tt: [
          "LambdaRank ның ачышы — югалту функциясен үткәреп, *градиентны* турыдан-туры билгеләү һәм аны парны алыштырганда метрика никадәр яхшырачагына үлчәү. Градиент зурлыгы — \\(1 - \\sigma(s_i - s_j)\\), ә авырлык — \\(|\\Delta\\text{nDCG}|\\) (5 нче лекциядәге nDCG).",
