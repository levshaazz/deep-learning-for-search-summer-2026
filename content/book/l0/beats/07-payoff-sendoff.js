    {
      ...
      body: {
        ...
        ru: [
          'Вот и весь инструктаж. Маршрут проложен: Get Data, Measure, Rank, по кругу, всё глубже с каждой неделей. Ты пересечёшь все три территории, соберёшь Корабль по одной детали за раз, и к защите проекта сделаешь то, что я всё обещаю, — встанешь к штурвалу и поведёшь его сам, без второго пилота за плечом.',
