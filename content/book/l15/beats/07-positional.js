    {
      ...
      body: {
        ...
        ru: [
          "Вот тайна, которую станок сам не выдаст: у внимания нет чувства порядка. Переставь нити на навое — узор выйдет переставленным ровно так же, и никто не возмутится. Оно читает *мешок* нитей, а не строку. Поэтому «кот укусил собаку» и «собаку укусил кот» приходят одной и той же кучей, и станок ткёт их одинаково. Для смысла это катастрофа.",
