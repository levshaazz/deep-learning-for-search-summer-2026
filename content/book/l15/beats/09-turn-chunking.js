    {
      ...
      imgAlt: {
        ...
        ru: 'Чанк Норрис вертушкой разбивает длинный свиток на равные отрывки; Токенозавр в углу щёлкает подслова; Серёга вымеряет перекрытие, чтобы ничего не провалилось между ломтями.',
