    {
      ...
      body: {
        ...
        ru: [
          "После BERT мастерская наполнилась роднёй — и я хочу быть честным: *ни один* не перестроил станок. Все четверо остаются encoder-only машинами, что ткут полотно целиком, в обе стороны. Каждый чинил *рецепт*, *детали* или *урок* — но не сам переплёт.",
          "**RoBERTa** просто обучил тот же станок *тщательнее*: больше пряжи, больше эпох, маска, что перетасовывается каждый проход, а не застывает, batch побольше — и выбросил NSP как балласт. **ALBERT** собрал то же полотно из *меньшего числа деталей* — факторизует эмбеддинг словаря и делит одни веса на все слои (но тонкий станок всё равно гонит полный проход: экономит память, а не вычисления).",
          "**DistilBERT** ставит рядом маленький станок-подмастерье и учит копировать *мягкие* решения мастера — примерно на *40% меньше, на 60% быстрее,* и всё ещё *~97%* качества. **ELECTRA** меняет *урок*: крошечный помощник подсовывает правдоподобные подделки, а ELECTRA судит *каждую нить* — оригинал или подмена? — и сигнал идёт со всех позиций, а не с 15% замаскированных. Четверо родни, одна машина.",
        ],
        tt: [
