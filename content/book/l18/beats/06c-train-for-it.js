    {
      ...
      body: {
        ...
        ru: [
          ...
          "И что это покупает? Честно говоря, совсем немного. Лучшая клетка в их таблице прибавляет меньше пункта nDCG, а одна клетка едет чуть *назад*. Именно поэтому я тебе это и рассказываю: разрыв между «усредни спан» и «выучи спан» мал, значит бесплатная версия — не бедная родственница обученной. Она и есть почти вся обученная. «Без обучения» здесь — не потолок, а пол; а потолок, как выяснилось, на расстоянии вытянутой руки.",
        ],
        tt: [
          ...
          "Ә бу нәрсә сатып ала? Дөресен әйткәндә, бик аз. Аларның таблицасындагы иң яхшы күзәнәк nDCG’ның бер пунктыннан да азрак өсти, ә бер күзәнәк бераз *артка* китә. Мин сиңа моны нәкъ шуңа сөйлим: «span’ны уртачала» белән «span’ны өйрән» арасындагы аерма кечкенә, димәк бушлай версия өйрәтелгәненең ярлы туганы түгел. Ул — өйрәтелгәненең күп өлеше үзе. «Өйрәтүсез» биредә түшәм түгел, ә идән; ә түшәм, күренә ки, кул сузымында.",
        ],
      },
    },
