...
def bench():
    ...
    return {
        ...
        "lexicalLeak": {
            "_doc": "Li 2020 Table 6 — Spearman ρ vs edit-distance: raw BERT cosine −50.49, GOLD human "
                    "similarity labels only −24.61. BERT clings to string surface ~2× harder than the gold "
                    "judgements do (its ρ with meaning itself is ≈ +59, cf. STS-B raw 59.04).",
            "cite": "Li 2020",
            "corrLexical": -50.49, "corrGoldEdit": -24.61,
        },
    }
